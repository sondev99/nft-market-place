  ...
  return (
    <MaxWidthWrapper>
      <footer className=" text-sm mt-16">
        ...
        <div className="grid grid-cols-2 gap-y-10 gap-x-5 sm:gap-x-8 md:grid-cols-4 lg:grid-cols-5 lg:gap-x-10 py-10 border-solid">
          <div>
            <Image
              src={images.logo}
              alt="footer logo"
          ...
          <FooterList>
            ...
            <ul className="mt-5 space-y-4 font-medium">
              <li>
          ...
          <div className="">
            ...
            <p className="w-full">
              ...
              tempore deleniti ab nisi, aut molestias numquam dolore consequatur
              aliquam quae reprehenderit? Iste, hic!
            </p>
          </div>
        </div>
